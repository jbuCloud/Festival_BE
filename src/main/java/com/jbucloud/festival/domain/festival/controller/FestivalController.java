...
public class FestivalController {
    ...
    @Operation(summary = "타입별 축제 정보 조회", description = "지정된 정보 타입에 해당하는 축제들을 조회합니다. (NOTICE, BOOTH, EVENT, FOOD_TRUCK, TIMETABLE)")
    ...
    @Operation(summary = "위치별 축제 정보 조회", description = "지정된 위치에 해당하는 축제들을 조회합니다.(BOOTH_ZONE, STAGE_PHOTO_BOOTH, DIY_DATE_BOOTH, \n" +
